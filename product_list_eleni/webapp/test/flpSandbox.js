		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Product List",
									"targetURL": "#productlisteleni-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"productlisteleni-display": {
								"semanticObject": "productlisteleni",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=productlisteleni",
									"url": sap.ui.require.toUrl("productlisteleni")
								}
							}
						}
					}
